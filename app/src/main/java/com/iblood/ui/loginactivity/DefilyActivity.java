...
import com.iblood.ui.loginactivity.framents.OneFramentImage;
import com.iblood.ui.loginactivity.framents.ThreFramentsImage;
import com.iblood.ui.loginactivity.framents.TwoFramentsImage;
import com.iblood.ui.loginactivity.shipei.ViewPagerAdapter;

import java.util.ArrayList;
import java.util.List;

public class DefilyActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (App.preferences.getString("domeYinDao", "2").equals("1")) {
            ...
            setContentView(R.layout.defilyactivity);
            initView();
        }
    }
