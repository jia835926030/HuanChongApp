...
public class LiaoTianActivity extends AppCompatActivity {
    ...
    @BindView(R.id.name_liaotian)
    TextView nameLiaotian;
    ...
    @BindView(R.id.toolbar_liaotian)
    Toolbar toolbarLiaotian;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarLiaotian.setNavigationIcon(R.drawable.back_gray);
        toolbarLiaotian.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
