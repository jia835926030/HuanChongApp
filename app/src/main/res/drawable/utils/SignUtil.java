...
public class SignUtil {
	...
	public static String getSign(Map<String, Object> params) {
		String sign = com.huanchong.pet.utils.Md5Encrypt.md5(createLinkString(params) + "1", "utf-8");
		return sign;
	}
	...
	public static String getSign(List<Map<String, Object>> data) {
		String sign = com.huanchong.pet.utils.Md5Encrypt.md5(createLinkString(data) + "1", "utf-8");
		return sign;
	}
