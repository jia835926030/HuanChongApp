...
public class CJSON extends JSON {
	...
	public static String getDESC(String json) {
		return com.huanchong.pet.utils.CJSON.parseObject(json).getString("desc");
	}
	...
	public static String getRESULT(String json) {
		return com.huanchong.pet.utils.CJSON.parseObject(json).getString("result");
	}
	...
	public static Boolean getRET(String json) {
		return com.huanchong.pet.utils.CJSON.parseObject(json).getBoolean("ret");
	}
	...
	private static void buildJSON(Context context, Map<String, Object> params) {
		params = com.huanchong.pet.utils.MapUtils.sortMapByKey(params);
		...
		if (AppUtils.getUser() != null
			...
			toContent(com.huanchong.pet.utils.TableUtils.UserInfo.USERID, AppUtils.getUser()
					.getUserId());
			json.append(COMMA);
		}
		toContent(TokenUtil.TOKEN, com.huanchong.pet.utils.FileUtil.getToken());
	...
	private static void toContent(String str1, Object str2) {
		...
		if (str2 != null && str2 != "" && (str2 instanceof List)) {
			json.append(com.huanchong.pet.utils.CJSON.toJSONString(str2));
		} else {
			json.append(START_CONTENT);
			json.append(str2);
			json.append(END_CONTENT);
