...
public class MarketUtils {
	...
	public static final String APP_STORE_taobao = "com.taobao.appcenter";// 淘宝手机助手
	public static final String APP_STORE_yybao = "com.tencent.android.qqdownloader";// 应用宝
	public static final String APP_STORE_anzhuo = "com.hiapk.marketpho";// 安卓市场
	public static final String APP_STORE_anzhi = "cn.goapk.market ";// 安智市场
	...
	public static void launchAppDetail(String appPkg, String marketPkg) {
		try {
			...
			com.huanchong.pet.utils.AppUtils.getAppContext().startActivity(intent);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
